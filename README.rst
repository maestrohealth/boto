...
master, and then master updated to 2.47.0 from the main `boto/boto`
master.
...
to this version from 2.47.0 properly.

The rest of this README is the original boto 2.47.0 README, and some 
